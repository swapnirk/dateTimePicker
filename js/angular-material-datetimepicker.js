(function () {
  ...
  var template =
    ...
    '                <div ng-if="picker.params.time&&picker.params.date">><div class="dtp-icon noselect active" ngClass="" id="dateIcon">' +
    '                    <a href="#" mdc-dtp-noclick ng-click="picker.showDate()"><i class="fa fa-calendar-o fa-2x" aria-hidden="true"></i></a>' +
    '                </div>' +
    '                <div class="dtp-icon1 noselect" id="timeIcon">' +
    '                    <a href="#" mdc-dtp-noclick ng-click="picker.showTime()"><i class="fa fa-clock-o fa-2x" aria-hidden="true"></i></a>' +
    '                </div><br><br></div>' +
    ...
    '                </div>' +
    '            </header>' +
    '            <div class="dtp-date" ng-if="picker.currentView===picker.VIEWS.DATE">' +
    '             <div layout="row" >' +
      ...
      switch (this.currentView) {
        case VIEW_STATES.DATE:
          if (this.params.time === true) {
            this.initHours();
            angular.element(document.querySelector('#timeIcon')).addClass('active');
            angular.element(document.querySelector('#dateIcon')).removeClass('active');
          } else {
            this.hide(true);
          }
          break;
    ...
    cancel: function () {
      if (this.params.time) {
        switch (this.currentView) {
          ...
          case VIEW_STATES.HOUR:
            if (this.params.date) {
              angular.element(document.querySelector('#dateIcon')).addClass('active');
              angular.element(document.querySelector('#timeIcon')).removeClass('active'); 
              this.initDate();
            }
            else {
              this.hide();
